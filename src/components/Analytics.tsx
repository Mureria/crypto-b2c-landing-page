    ...
    <div className='w-full py-16 px-4 bg-white'>
        <div className='max-[1240] mx-auto grid md:grid-cols-2 '>
            ...
            <div className='flex flex-col justify-center items-center md:items-start'>
                ...
                <button className='bg-black w-[200px] rounded-md font-medium py-3 px-5 text-green-400 my-6 m-auto md:mx-0 hover:bg-black/90 ease-in-out'>Get Started</button>
            </div>
        </div>
